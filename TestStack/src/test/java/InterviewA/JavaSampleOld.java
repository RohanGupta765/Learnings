...
public class JavaSampleOld {
  public static final String AUTOMATE_USERNAME = "rohanrameshchand_8IBEwh";
  public static final String AUTOMATE_ACCESS_KEY = "mwpVLutdY6YTFgnpSeMy";
